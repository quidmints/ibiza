...
//
// VENDORED, NOT WRITTEN HERE. Byte-for-byte `lib/poseidon-solidity/PoseidonT5.sol` at upstream
// commit f3c925b9c5dbba4698e9cb597cc4035b6bfdbbd2, with exactly TWO mechanical edits:
//   1. `library PoseidonT5` -> `library PoseidonT5Inline`  (so both can coexist)
...
library PoseidonT5Inline {
  ...
  function hash(uint[4] memory) internal pure returns (uint) {
    assembly {
