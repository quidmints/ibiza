...
//
// VENDORED, NOT WRITTEN HERE. Byte-for-byte `lib/poseidon-solidity/PoseidonT4.sol` at upstream
// commit f3c925b9c5dbba4698e9cb597cc4035b6bfdbbd2, with exactly TWO mechanical edits:
//   1. `library PoseidonT4` -> `library PoseidonT4Inline`  (so both can coexist)
...
library PoseidonT4Inline {
  ...
  function hash(uint[3] memory) internal pure returns (uint) {
    assembly {
