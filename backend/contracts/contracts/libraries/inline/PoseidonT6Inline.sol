...
//
// VENDORED, NOT WRITTEN HERE. Byte-for-byte `lib/poseidon-solidity/PoseidonT6.sol` at upstream
// commit f3c925b9c5dbba4698e9cb597cc4035b6bfdbbd2, with exactly TWO mechanical edits:
//   1. `library PoseidonT6` -> `library PoseidonT6Inline`  (so both can coexist)
...
library PoseidonT6Inline {
  ...
  function hash(uint[5] memory) internal pure returns (uint) {
    assembly {
